 ...
 *  @param persistenceType the persistenceType of the data
 *
...
///-----------------------------------------------------------------------------
/// @name Getting the MSAIPersistenceType
///-----------------------------------------------------------------------------

/**
 * Get the persistence type fpr a given path.
 *
