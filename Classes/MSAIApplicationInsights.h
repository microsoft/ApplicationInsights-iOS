...
/**
 * Flag which determines if the "Developer mode" is enabled. If the SDK is in "Developer Mode",
 * additional logging output will be generated by the all modules.
 * Also telemetry data will be sent after 3s or 5 items to make debugging easier.
 * This is ignored if the app is running in the App Store and reverts to the default or set value
 * in that case. Default is NO.
 *
 * @warning This property must to be set before calling `startManager`
 */
@property (nonatomic, assign, getter=isDeveloperModeEnabled) BOOL developerModeEnabled;
